  ...
  fr: {
    ...
    about: {
      ...
      copy: [
        ...
        "Je cherche une entreprise où je pourrai continuer à progresser, relever des défis utiles et m'investir pleinement. Je suis curieuse, rigoureuse et j'adore comprendre comment tout fonctionne.",
      ],
  ...
  en: {
    ...
    about: {
      ...
      copy: [
        ...
        "I’m looking for a company where I can keep learning, tackle meaningful challenges, and fully commit. I’m curious, thorough, and I love understanding how everything works.",
      ],
